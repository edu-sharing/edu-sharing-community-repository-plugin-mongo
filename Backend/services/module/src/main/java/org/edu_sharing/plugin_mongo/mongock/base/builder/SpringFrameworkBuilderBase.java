package org.edu_sharing.plugin_mongo.mongock.base.builder;
...
public abstract class SpringFrameworkBuilderBase<
        SELF extends SpringFrameworkBuilderBase<SELF, CONFIG>,
        CONFIG extends MongockConfiguration>
        extends RunnerBuilderBase<SELF, CONFIG> {

    private static final String DEFAULT_PROFILE = "default";

    protected SpringFrameworkBuilderBase(BuilderType builderType,
