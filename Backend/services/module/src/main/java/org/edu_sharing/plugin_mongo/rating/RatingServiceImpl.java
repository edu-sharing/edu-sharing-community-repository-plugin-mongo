...
public class RatingServiceImpl implements RatingService, AwareAlfrescoDeletion {
    ...
    public RatingServiceImpl(MongoDatabaseFactory mongoDatabaseFactory, NodeService nodeService, IntegrityService integrityService, ServiceFactory serviceFactory, ConfigService configService) {
