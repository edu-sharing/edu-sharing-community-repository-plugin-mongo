...
public class MongoNodeServiceImpl extends NodeServiceImpl {
    ...
    public void addAspect(String nodeId, String aspect) {
        ...
        workspaceCollection.updateOne(Filters.eq(MongoDocumentAdapter.ID_KEY, nodeId), Updates.addToSet("aspects", aspect));
    }
    ...
    public void removeAspect(String nodeId, String aspect) {
        ...
        workspaceCollection.updateOne(Filters.eq(MongoDocumentAdapter.ID_KEY, nodeId), Updates.pull("aspects", aspect));
    }
    ...
    public boolean hasAspect(String storeProtocol, String storeId, String nodeId, String aspect) {
        ...
        return workspaceCollection.find(Filters.and(
                        Filters.eq(MongoDocumentAdapter.ID_KEY, nodeId),
    ...
    public void removeProperty(String storeProtocol, String storeId, String nodeId, String property) {
        ...
        List<String> props =  Arrays.asList(property);
    ...
    public void createVersion(String nodeId) throws Exception {
        ...
        ReplaceOptions options = new ReplaceOptions().upsert(true);
        versionCollection.replaceOne(Filters.eq(MongoDocumentAdapter.ID_KEY, key), document, options);
    }
    ...
    public void deleteVersionHistory(String nodeId) throws Exception {
        ...
        versionCollection.deleteMany(Filters.regex(MongoDocumentAdapter.ID_KEY, "^" + nodeId + "_"));
    }
    ...
    public HashMap<String, HashMap<String, Object>> getVersionHistory(String nodeId) throws Throwable {
        ...
        versionCollection.find(Filters.regex(MongoDocumentAdapter.ID_KEY, "^" + nodeId + "_"))
                .sort(Sorts.descending(MongoDocumentAdapter.ID_KEY))
                .into(documents);
    ...
    public void removeNode(String nodeId, String parentId, boolean recycle) {
        ...
        workspaceCollection.deleteMany(Filters.in(MongoDocumentAdapter.ID_KEY, nodes.stream().map(NodeRef::getId).collect(Collectors.toList())));
        versionCollection.deleteMany(Filters.in(MongoDocumentAdapter.ID_KEY, nodes.stream().map(x -> "/^" + x.getId() + "_").collect(Collectors.toList())));
    }
