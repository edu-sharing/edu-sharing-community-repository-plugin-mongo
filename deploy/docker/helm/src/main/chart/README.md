...
| `config.metrics.rules.mongoInsufficientMemberships.enabled`         | Enable metric rule mongoInsufficientMemberships             | `true`                                                                                              |
| `config.metrics.rules.mongoInsufficientMemberships.for`             | Set metric rule mongoInsufficientMemberships wait interval  | `5m`                                                                                                |
| `config.metrics.rules.mongoInsufficientMemberships.labels.severity` | Set metric rule mongoInsufficientMemberships severity level | `critical`                                                                                          |
| `config.metrics.rules.mongoReplicationLag.enabled`                  | Enable metric rule mongoReplicationLag                      | `true`                                                                                              |
| `config.metrics.rules.mongoReplicationLag.config.max`               | Set metric rule mongoReplicationLag max lag                 | `20`                                                                                                |
| `config.metrics.rules.mongoReplicationLag.for`                      | Set metric rule mongoReplicationLag wait interval           | `5m`                                                                                                |
| `config.metrics.rules.mongoReplicationLag.labels.severity`          | Set metric rule mongoReplicationLag severity level          | `critical`                                                                                          |
| `config.metrics.rules.mongoUp.enabled`                              | Enable metric rule mongoUp                                  | `true`                                                                                              |
| `config.metrics.rules.mongoUp.for`                                  | Set metric rule mongoUp wait interval                       | `5m`                                                                                                |
| `config.metrics.rules.mongoUp.labels.severity`                      | Set metric rule mongoUp severity level                      | `critical`                                                                                          |
...
| `init.permission.securityContext.runAsNonRoot`                      | Running as Non-root                                         | `false`                                                                                             |
