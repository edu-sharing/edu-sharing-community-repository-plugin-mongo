...
| `config.metrics.rules.mongoInsufficientMemberships.for`             | Set metric rule mongoInsufficientMemberships wait interval  | `1m`                                                                                                |
...
| `config.metrics.rules.mongoReplicationLag.for`                      | Set metric rule mongoReplicationLag wait interval           | `1m`                                                                                                |
...
| `config.metrics.rules.mongoUp.for`                                  | Set metric rule mongoUp wait interval                       | `1m`                                                                                                |
